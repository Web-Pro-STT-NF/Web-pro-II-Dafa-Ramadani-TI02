...
<div class="row">
        ...
        <div class="row">
            <div class="col-12">
                <p class="mt-3 d-flex ">Form Nilai siswa</p>
                <hr>
            </div>
        </div>
        <div class="row">
        ...
        <div class="container px-4 px-lg-5">
            <p class="text-center">Created by <a href="https://github.com/Web-Pro-STT-NF/Web-pro-II-Dafa-Ramadani-TI02">Dafa Ramadani</a> &copy; 2022</p>
        </div>
    </footer>
        </div>
    </div>
